...
| 4 | 强制 原型 | `doc/design/prototype/index.html` |
...
> 按需产出（由项目具体需求决定）：Agent架构设计文档、前端架构设计文档、UI设计文档（含设计系统说明）、`prototype/index.html`、Figma设计交付说明、API接口设计文档、数据库设计文档（含数据字典）、缓存与消息设计说明。
>
