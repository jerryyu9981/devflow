...
| Step 2 架构与设计 | 架构设计、API设计、UI设计、数据库设计、安全设计 | LS/Glob 列出 doc/design 目录核对 |
| Step 3 开发 / 编码 | 源代码、DevLogReport、自测证据 | LS/Glob 列出 src 和 doc/devlog 目录核对 |
